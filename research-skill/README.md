...
A standalone Claude Code skill that runs any research topic through a panel of 18 domain experts in parallel, then synthesises their findings into a cross-domain report — all saved as local markdown files.
...
You give it a topic. It deploys up to 18 domain experts simultaneously — each one analyses the topic from their unique perspective (UX research, behavioral psychology, philosophy, cultural anthropology, game design, economics, metaphysics, and more). When all experts finish, a synthesis agent cross-references their findings and extracts the most important insights, contradictions, and blind spots.
...
| Behavioral Psychologist | Motivation, decision-making, emotion, habit loops |
| Cultural Anthropologist | Symbolism, rituals, cross-cultural meaning |
| Game Designer | Mechanics, progression, player agency, loops |
| Narrative Designer | Storytelling, world-building, meaning-making |
| Visual Arts Critic | Aesthetics, composition, art direction |
...
| Market Analyst | Positioning, competition, monetisation, audience |
| Cognitive Scientist | Attention, memory, cognitive load, perception |
| Accessibility Specialist | Inclusive design, universal access |
| Environmental Psychologist | Space, nature, restorative experiences |
| Metaphysics / Spiritual Scholar | Archetypes, consciousness, spiritual traditions |
| Sociologist | Community, identity, power structures, norms |
| Technology Architect | Feasibility, platforms, scalability, risks |
| Economist | Incentives, resource allocation, pricing |
| Educator / Learning Designer | Pedagogy, scaffolding, skill development |
| Futurist / Trend Analyst | Emerging patterns, long-term trajectories |

The skill auto-selects the most relevant experts for your topic. You can also control exactly how many to use.
...
**Use `--experts 5` for a quick scan.** Five well-chosen experts in 3 minutes beats ten shallow ones.
